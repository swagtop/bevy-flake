      ...
      mkBf =
        ...
        let
          configNoPkgs = assembleConfigs configList (
            # To construct the 'pkgs' used in the configs, we may first need to
            # get the 'system' it is for. One is generated by the for each
            # system in the 'systems' config attribute. We can get this by
            # assembling the configs without any 'pkgs' first, and only use the
            # 'systems' output of this.
